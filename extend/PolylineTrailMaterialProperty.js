// import * from '../js/Cesium/Cesium.js';
...
Cesium.defineProperties(PolylineTrailMaterialProperty.property, {
	isConstant: {
		get: function() {
			return false;
		}
...
PolylineTrailMaterialProperty.prototype.getValue = function(time, result) {
	...
	reesult.time = ((performance.now() - this.time) % this.duration) / this.duration;
	return result;
}
...
Cesium.Material.PolylineTrailImage = './Texture/colors.png';
